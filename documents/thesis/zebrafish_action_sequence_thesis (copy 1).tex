...
\begin{table}[h!]
  \begin{center}\tiny
    ...
    \hline
     &\multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\healthy\\condition\\\end{tabular}}&\multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\hypoactive\\condition\\\end{tabular}}&\multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\hyperactive\\condition\\\end{tabular}}&\multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\convulsant\\condition\\\end{tabular}}\\ \cline{2-9}
       &\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\not stratified\\in\\bout length\end{tabular}&\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\stratified\\in\\bout length\end{tabular} & \begin{tabular}[c]{@{}c@{}c@{}c@{}}\\not stratified\\in\\bout length\end{tabular}&\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\stratified\\in\\bout length\end{tabular}&\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\not stratified\\in\\bout length\end{tabular}&\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\stratified\\in\\bout length\end{tabular}&\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\not stratified\\in\\bout length\end{tabular}&\begin{tabular}[c]{@{}c@{}c@{}c@{}}\\stratified\\in\\bout length\end{tabular} \\ \hline 
       \begin{tabular}[c]{@{}c@{}c@{}c@{}}\\Total of\\descriptive\\statistics\end{tabular}&375&1094&290&818&541&1796&580&2156 \\ \hline
    \end{tabular}
  \end{center}
    \caption{Number of descriptive statistics extracted from the action sequences in each of the four conditions.}
\end{table}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoLow_full_in.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoHigh_full_in.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoPTZ_full_in.png}
...
\begin{tabular}{|c|c|c|c|}
\hline
                                                    & \begin{tabular}[c]{@{}c@{}}hypoactive\\condition\end{tabular}                &\begin{tabular}[c]{@{}c@{}} hyperactive\\condition \end{tabular}              & \begin{tabular}[c]{@{}c@{}}convulsant\\condition\end{tabular}                \\ \hline
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoHigh_full_in_T_only.png}
\caption{By using the second set of descriptive statistics, the first and second PC of the control in healthy(grey star) and the control in hyperactive(orange star) along with three compounds Aripiprazole, NDMCHigh and PCAP2 in three different dosages(square for a high dose, triangle for a medium dose and a circle for a low dose) in the healthy condition(green) and in the hyperactive condition(blue). Colour intensity coded by progress in time.}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{PTZ_full_in_T_only.png}
\caption{By using the second set of descriptive statistics, the first and second PC of the control in healthy(grey star) and the control in convulsant(orange star) along with three compounds Aripiprazole, NDMCHigh and PCAP2 in three different dosages(square for a high dose, triangle for a medium dose and a circle for a low dose) in the healthy condition(green) and in the convulsant condition(blue). Colour intensity coded by progress in time.}
\end{center}
\end{figure}
\newpage
...
\\Plots of the first and second principal components of a PCA, conducted on a set of all descriptive statistics, where the turn and turn transition proportions were stratified in bout length, visually differed from the previous plots, examples in Figures 12, 13, 14. \\First 10 most influential descriptive statistics shown in Table 5. PCA results for all 12 compounds, using the third set of descriptive statistics in Appendix B.1, a longer list of descriptive statistics ranked according to their influence in Appendix B.2.\\Cumulative variance accounted by the first five principal components ranged from approximately 15\% to 22\% with the entire third set of descriptive statistics, while for the set of the first 50 most influential descriptive statistics, the first principal component accounted for approximately 72\% to 90\% of total variance.
\newpage

\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoLow_full_in_Strat.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoHigh_full_in_Strat.png}
\caption{By using the third set of descriptive statistics, the first and second PC of the control in healthy(grey star) and the control in hyperactive(orange star) along with three compounds Aripiprazole, NDMCHigh and PCAP2 in three different dosages(square for a high dose, triangle for a medium dose and a circle for a low dose) in the healthy condition(green) and in the hyperactive condition(blue). Colour intensity coded by progress in time.}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{PTZ_full_in_Strat.png}
\caption{By using the third set of descriptive statistics, the first and second PC of the control in healthy(grey star) and the control in convulsant(orange star) along with three compounds Aripiprazole, NDMCHigh and PCAP2 in three different dosages(square for a high dose, triangle for a medium dose and a circle for a low dose) in the healthy condition(green) and in the convulsant condition(blue). Colour intensity coded by progress in time.}
\end{center}
\end{figure}
\newpage
...
\end{table}
Removing bout count and bout length descriptive statistics from the set did not change the plots of the first and second principal component. In Figures 15, 16 and 17, examples of plots of the first and second principal component of a PCA, conducted on the fourth set of descriptive statistics with turn and turn transition proportions per bout length only. \\First 10 most influential descriptive statistics are shown in Table 6 and remain almost the same as when the bout count and bout length descriptive statistics were included. PCA results for all 12 compounds, using the fourth set of descriptive statistics in Appendix B.1, a longer list of descriptive statistics ranked according to their influence in Appendix B.2. \\Cumulative variance accounted by the first five principal components remained in the range from approximately 15\% to 22\% with the entire fourth set of descriptive statistics, while for the set of the first 50 most influential descriptive statistics, the first principal component accounted for approximately 72\% to 90\% of total variance, as when the third set was used.

\newpage

\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoLow_full_in_Strat_T_only.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{ApoHigh_full_in_Strat_T_only.png}
\caption{By using the fourth set of descriptive statistics, the first and second PC of the control in healthy(grey star) and the control in hyperactive(orange star) along with three compounds Aripiprazole, NDMCHigh and PCAP2 in three different dosages(square for a high dose, triangle for a medium dose and a circle for a low dose) in the healthy condition(green) and in the hyperactive condition(blue). Colour intensity coded by progress in time.}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=14cm,height=17cm]{PTZ_full_in_Strat_T_only.png}
\caption{By using the fourth set of descriptive statistics, the first and second PC of the control in healthy(grey star) and the control in convulsant(orange star) along with three compounds Aripiprazole, NDMCHigh and PCAP2 in three different dosages(square for a high dose, triangle for a medium dose and a circle for a low dose) in the healthy condition(green) and in the convulsant condition(blue). Colour intensity coded by progress in time.}
\end{center}
\end{figure}
\newpage
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=8cm,height=8cm]{DarkApoLow_set1_PCA_tree.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=8cm,height=8cm]{DarkPTZ_set1_PCA_tree.png}
...
\bibitem{ref16} 
Baxendale S., Holdsworth C.J., Meza Santoscoy P.L., Harrison R. M., Fox J. , Parkin C.A., Ingham P.W., Cunliffe P.W., Identification of compounds with anti-convulsant properties in a zebrafish model of epileptic seizures. \text{Disease Models and Mechanisms} \textbf{5} 773-784 (2012) .
\bibitem{ref17} 
