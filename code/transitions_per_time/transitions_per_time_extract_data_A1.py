...
print(word2Dictionary[2]["ss"][0][0])
...
with open('../../../../processed_data/simple_word_search/A1/'+condition+'/Disease_'+drug+ '_' + condition +'_word2','wt') as word2File:
...
with open('../../../../processed_data/simple_word_search/A1/'+condition+'/Disease_'+drug+ '_' + condition +'_word3','wt') as word3File:
