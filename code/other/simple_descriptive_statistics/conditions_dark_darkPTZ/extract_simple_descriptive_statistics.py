...
with open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/action_sequence_length/all/'+sys.argv[1]+'Lengths','wt') as seqLengthsFile, open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/number_of_bouts_per_timeframe/all/'+sys.argv[1]+'NumberOfBouts','wt') as numberOfBoutsFile, open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/mean_bout_length_per_timeframe/all/'+sys.argv[1]+'meanLengthOfBout','wt') as meanLengthOfBoutFile, open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/sd_bout_length_per_timeframe/all/'+sys.argv[1]+'sdLengthOfBout','wt') as sdLengthOfBoutFile, open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/action_sequence_length/all/'+sys.argv[1]+'LengthsMean','wt') as seqLengthsMeanFile, open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/number_of_bouts_per_timeframe/all/'+sys.argv[1]+'NumberOfBoutsMean','wt') as numberOfBoutsMeanFile, open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/mean_bout_length_per_timeframe/all/'+sys.argv[1]+'meanLengthOfBoutMean','wt') as meanLengthOfBoutMeanFile, open('../../../processed_data/simple_descriptive_statistics_Dark_DarkPTZ/sd_bout_length_per_timeframe/all/'+sys.argv[1]+'sdLengthOfBoutMean','wt') as sdLengthOfBoutMeanFile:
