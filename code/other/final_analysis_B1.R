...
#check with wilcox.test(Length2BoutScootsProportion,Length1BoutScootsProportion,paired=TRUE) for the strata difference
...
#what is this
#> qchisq(0.95, df.residual(model_poisson))
#[1] 455.038
#> deviance(model_poisson)
#[1] 3097.44
#> pr <- residuals(model_poisson,"pearson")
#> sum(pr^2)
#[1] 3223.003
