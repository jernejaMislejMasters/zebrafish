...
png(paste0("~/git/zebrafish_action_sequence_project/results/plots/final_analysis/PCA_plots/",condition,"/All_together_doses_",condition,"set3.png"),width=1500,height=750)
par(mar=c(5, 5, 5, 21), xpd=TRUE)
plot(PC1_control_healthy,PC2_control_healthy,xlim=c(xlimit0,xlimit1),ylim=c(ylimit0,ylimit1), pch=19, cex=6, col="grey30", xlab="PC1", ylab="PC2", main=paste0("PCA based plot of all compounds and their\ndirection in dosage examined in the ",state," condition"))
...
PC1_control_healthy<-mean(pca_model$ind$coord[grep("Control_Dark$",full_together$Group),1])
PC2_control_healthy<-mean(pca_model$ind$coord[grep("Control_Dark$",full_together$Group),2])
png(paste0("~/git/zebrafish_action_sequence_project/results/plots/final_analysis/PCA_plots/",condition,"/All_together_doses_",condition,"set4.png"),width=1500,height=750)
par(mar=c(5, 5, 5, 21), xpd=TRUE)
plot(PC1_control_healthy,PC2_control_healthy,xlim=c(xlimit0,xlimit1),ylim=c(ylimit0,ylimit1), pch=19, cex=6, col="grey30", xlab="PC1", ylab="PC2", main=paste0("PCA based plot of all compounds and their\ndirection in dosage examined in the ",state," condition"))
